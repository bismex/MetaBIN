...
_C.META.DATA.NUM_VIEW = 4
_C.META.DATA.IMS_PER_BATCH = 64
_C.META.DATA.NUM_INSTANCE = 4
...
_C.META.SOLVER.INIT.NUM_EPOCH = 0

_C.META.SOLVER.INIT.SCHED = 'constant'
...
_C.META.SOLVER.FINAL.NUM_EPOCH = 60 # based on meta-test set
_C.META.SOLVER.FINAL.SCHED = 'MultiStepLR'
...
_C.META.SOLVER.NO_TRAIN_ORIGINAL = False
