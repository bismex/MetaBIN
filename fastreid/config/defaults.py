...
_C.META.DATA.MTRAIN_MINI_BATCH = 40 # should be a multiply of num_domain x num_instance
_C.META.DATA.MTRAIN_NUM_INSTANCE = 4
_C.META.DATA.MTEST_MINI_BATCH = 40 # should be a multiply of num_domain x num_instance
...
_C.META.SOLVER.LR_FACTOR.META_CYCLIC_MIDDLE_LR = 0.1
_C.META.SOLVER.LR_FACTOR.META_CYCLIC_NEW = False
...
_C.MODEL.LOSSES.TRI_ADD.MARGIN = 0.3
_C.MODEL.LOSSES.TRI_ADD.FEAT_ORDER = 'before'
_C.MODEL.LOSSES.TRI_ADD.NORM_FEAT = False
_C.MODEL.LOSSES.TRI_ADD.HARD_MINING = False
_C.MODEL.LOSSES.TRI_ADD.SCALE = 1.0
_C.MODEL.LOSSES.TRI_ADD.NEW_POS = [1,0,0]
_C.MODEL.LOSSES.TRI_ADD.NEW_NEG = [0,1,1]
...
_C.MODEL.LOSSES.SCT.TYPE = 'euclidean' # 'cosine', 'euclidean'
