matlab -nodisplay -r "make_sh('MetaBIN7', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN7/', '', 1, 1, 'MetaBIN7/cpu1', ''); make_sh('MetaBIN7', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN7/', '', 2, 1, 'MetaBIN7/cpu2', ''); make_sh('MetaBIN7', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN7/', '', 5, 1, 'MetaBIN7/cpu5', ''); make_sh('MetaBIN7', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN7/', '--resume', 5, 1, 'MetaBIN7/resume5', ''); make_sh('MetaBIN7', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN7/', '--resume', 1, 1, 'MetaBIN7/resume1', ''); make_sh('MetaBIN7', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN7/', '--resume', 2, 1, 'MetaBIN7/resume2', ''); exit" 
