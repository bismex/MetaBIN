matlab -nodisplay -r "make_sh('MetaBIN4', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN4/', '', 1, 1, 'MetaBIN4/cpu1', ''); make_sh('MetaBIN4', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN4/', '', 3, 1, 'MetaBIN4/cpu3', ''); make_sh('MetaBIN4', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN4/', '', 5, 1, 'MetaBIN4/cpu5', ''); make_sh('MetaBIN4', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN4/', '--resume', 5, 1, 'MetaBIN4/resume5', ''); make_sh('MetaBIN4', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN4/', '--resume', 3, 1, 'MetaBIN4/resume3', ''); exit" 
