matlab -nodisplay -r "make_sh('MetaBIN2', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN2/', '', 1, 1, 'MetaBIN2/cpu1', ''); make_sh('MetaBIN2', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN2/', '', 3, 1, 'MetaBIN2/cpu3', ''); make_sh('MetaBIN2', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN2/', '', 5, 1, 'MetaBIN2/cpu5', ''); make_sh('MetaBIN2', 'seokeon_torch16', 'python3 ./tools/train_net.py --config-file ./configs/MetaBIN2/', '--resume', 5, 1, 'MetaBIN2/resume5', ''); exit" 
